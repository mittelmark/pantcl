...
The *pantcl filter* supports as well generation of filters for other tools
...
|.emf   | Jasspa MicroEmacs  (me)   | [http://www.jasspa.com](http://www.jasspa.com/) |
...
The attribute filter should point either using a relative or an absolute path
...
How should an actual filter implementation look like:
